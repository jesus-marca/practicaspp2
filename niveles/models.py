...
class Lesson(models.Model):
    ...
    def get_absolute_url(self):
        # return reverse('niveles:lesson_list', kwargs={'slug':self.subject.slug, 'standard':self.Standard.slug})
        return reverse('niveles:lesson_detail', kwargs={'slug':self.slug, 'standard':self.Standard.slug,'subject':self.subject.slug})
