    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True)),
                ('slug', models.SlugField()),
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='niveles.lesson')),
                ('standard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='niveles.standard')),
            ],
        ),
    ]
